...
CELERY_BEAT_SCHEDULE = {
    # Задача для обновления статистики каждые 10 секунд
    'update_stats_every_12_hours': {
        'task': 'stats.tasks.update_stats_every_12_hours',
        'schedule': 10.0,  # Запускать задачу каждые 10 секунд
    },
}